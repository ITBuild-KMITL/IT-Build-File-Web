      ...
      <div className="bg-emerald-100 py-10">
        <div className="container mx-auto px-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              <Image src={`https://api.file.itbuild.it22.dev/file/path/user-d5214fa0-0763-489a-ab8a-48f9df9466a7IMG_1405.jpeg=`} width={75} height={75} alt="Founder" className="rounded-full aspect-square object-cover" />
              <div>
